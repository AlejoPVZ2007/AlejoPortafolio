...
function updateCarritoUI(){ //Funcion para actualizar interfaz de carrito
    ...
    carItems.forEach(item =>{
        ...
        li.textContent = `${item.nombre} - S/${item.precio}`; //Estableciendo el texto del elemento en lista
...
function compra(){ //funcion para realizar la compra
    alert(`Compra realizada! Total: S/${carTotal}`); //Muestra una alerta con la suma total de la compra
